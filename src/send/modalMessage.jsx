...
const ModalMessage = (props) => {
  ...
  const onSendMessageButtonClick = () => {
    axios
    .post("http://52.78.60.246:3000/sendMessage", {
      _id: dbId,
      letters: {
        cardType: cardType,
              ...
              <div className="message-modal-area">
                <main className="message-modal-main">
                  ...
                  <div className="send-message-unkki">
                    ...
                    {
                      cardType === 'HI'
                      ? <img className="send-message-unkki-img" src="../../img/unkki-hi.png" alt="hi"/>
                      : <img className="send-message-unkki-img" src="../../img/unkki-heart.png" alt="hi"/>
                    }
